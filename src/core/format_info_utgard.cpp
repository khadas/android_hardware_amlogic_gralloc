...
const format_info_t formats[] = {
	...
	},
	{
		...
		.npln = 1, .ncmp = { 4, 0, 0 }, .bps = 8, .bpp_afbc = { 0, 0, 0 }, .bpp = { 32, 0, 0 },
		.hsub = 0, .vsub = 0, .align_w = 1, .align_h = 1, ALIGN_W_CPU_DEFAULT,
	...
	},
	{
		...
		.npln = 1, .ncmp = { 4, 0, 0 }, .bps = 16, .bpp_afbc = { 0, 0, 0 }, .bpp = { 64, 0, 0 },
		.hsub = 0, .vsub = 0, .align_w = 1, .align_h = 1, ALIGN_W_CPU_DEFAULT,
		.tile_size = 1, .has_alpha = true, .is_rgb = true, .is_yuv = false,
		.afbc = false, .linear = true, .yuv_transform = true, .flex = true,
	},
	...
	/* 420 (8-bit) */
	{
		...
		.npln = 1, .ncmp = { 3, 0, 0 }, .bps = 8, .bpp_afbc = { 0, 0, 0 }, .bpp = { 0, 0, 0 },
		.hsub = 2, .vsub = 2, .align_w = 2, .align_h = 2, ALIGN_W_CPU_DEFAULT,
		.tile_size = 1, .has_alpha = false, .is_rgb = false, .is_yuv = true,
		.afbc = false, .linear = false, .yuv_transform = false, .flex = false,
	},
	{
	...
	/* 422 (8-bit) */
	{
		...
		.npln = 1, .ncmp = { 3, 0, 0 }, .bps = 8, .bpp_afbc = { 0, 0, 0 }, .bpp = { 16, 0, 0 },
	...
	/* 420 (10-bit) */
	{
		...
		.npln = 1, .ncmp = { 3, 0, 0 }, .bps = 10, .bpp_afbc = { 0, 0, 0 }, .bpp = { 0, 0, 0 },
		.hsub = 2, .vsub = 2, .align_w = 2, .align_h = 2, ALIGN_W_CPU_DEFAULT,
		.tile_size = 1, .has_alpha = false, .is_rgb = false, .is_yuv = true,
		.afbc = false, .linear = false, .yuv_transform = false, .flex = false,
	},
	...
	/* 422 (10-bit) */
	{
		...
		.npln = 1, .ncmp = { 3, 0, 0 }, .bps = 10, .bpp_afbc = { 0, 0, 0 }, .bpp = { 32, 0, 0 },
		.hsub = 2, .vsub = 1, .align_w = 2, .align_h = 1, ALIGN_W_CPU_DEFAULT,
		.tile_size = 1, .has_alpha = false, .is_rgb = false, .is_yuv = true,
		.afbc = false, .linear = true, .yuv_transform = false, .flex = true,
	},
